...
Detailed molecular analysis has revealed that many neutralizing antibodies to SARS-CoV-2 share sequence and structural features. [Joseph M. Taft 1 2 7, Cédric R. Weber 3](https://www.sciencedirect.com/science/article/pii/S0092867422011199?via%3Dihub) It can be used as a additional data source for pretraining machine learning models for prediction binding RBD with limited labeled data of the antibody of interest. 
